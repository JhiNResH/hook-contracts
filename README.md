...
| [TrustGateHook.sol](./contracts/hooks/TrustGateHook.sol) | A — Simple Policy | Trust score gate using the [RNWY on-chain oracle](https://basescan.org/address/0xD5fdccD492bB5568bC7aeB1f1E888e0BbA6276f4). Checks client trust on `fund`, provider trust on `submit`. 138,000+ agent scores across 3 registries and 11 chains. |
